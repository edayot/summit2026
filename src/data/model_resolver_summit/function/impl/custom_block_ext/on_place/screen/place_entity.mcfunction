...
execute summon text_display run function ./place_text_display: 
    ...
    data merge entity @s {Tags:["model_resolver_summit.screen.text_display", "model_resolver_summit.screen.image"], text: "", line_width: 500, background: 0}
...
execute summon text_display run function ./place_text_display_code: 
    ...
    data merge entity @s {Tags:["model_resolver_summit.screen.text_display", "model_resolver_summit.screen.code"], text: "", line_width: 500, background: -15198184, alignment:"left"}
    function model_resolver_summit:impl/set_screen_display/sculk_sensor
